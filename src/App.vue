...
<template>
  <div class="continer relative bg-repeat max-w-2000px mx-auto">
    <nav
      class="h-85px sm:h-105px w-[90%] bg-repeat opacity-90 fixed ml-5% z-10000 border-blue border-8px border-solid shadow-lg rounded-50px shadow-blue"
    >
